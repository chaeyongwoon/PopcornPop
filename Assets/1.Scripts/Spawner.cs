...
public class Spawner : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        touchText = _gamemanager.touchText;
        if (_cor != null)
        {
            StopCoroutine(_cor);
    ...
    IEnumerator Cor_Update()
    {
        ...
        while (true)
        {
            ...
            //12.06 update
#if !UNITY_EDITOR
touchText.text = $"{Input.touchCount}";
    ...
    void Spawn_Popcorn(int _count)
    {
        ...
        for (int i = 0; i < _count; i++)
        {
            ...
            if (Waiting_Pool.childCount > 0)
            {
                ...
                _popcorn.GetComponent<Popcorn>().PopcornState = Popcorn.State.Type0;
                ...
                else
                {
                    ...
                    _popcorn.GetComponent<Popcorn>().PopcornState = Popcorn.State.Type3;
                }
